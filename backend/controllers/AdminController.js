        ...
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#FFDBBB;border-radius:24px;box-shadow:0 25px 60px rgba(0,0,0,0.3);border:1px solid rgba(255,255,255,0.1);overflow:hidden">
          ...
          <tr>
            <td style="padding:60px 40px;text-align:center">
              ...
              <!-- 🔥 QUICK STEPS -->
              <div style="background:linear-gradient(135deg,#FFDBBB,#CCBEB1);border:2px solid #CCBEB1;border-radius:20px;padding:40px 30px;margin:35px 0">
                <h3 style="margin:0 0 30px 0;color:#664930;font-size:22px;font-weight:700;text-align:center">
                ...
                <div style="display:grid;gap:20px;font-size:15px;color:#475569;line-height:1.6">
                  <div style="display:flex;align-items:flex-start;gap:15px;padding:18px 0;border-bottom:1px solid #e5e7eb">
                    <div style="width:32px;height:32px;background:linear-gradient(135deg,#997E67,#664930);color:white;border-radius:10px;display:flex;align-items:center;justify-content:center;font-size:15px;font-weight:700;flex-shrink:0">1</div>
