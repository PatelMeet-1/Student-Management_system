...
<body style="margin:0;padding:20px;background:#CCBEB1;font-family:Arial">

<table width="100%" align="center">
<tr>
<td align="center">

<table width="500" style="background:#FFDBBB;border-radius:10px;overflow:hidden">
...
<p>Use the OTP below to recover your account</p>
...
<tr>
<td style="background:#664930;color:white;text-align:center;padding:20px">
...
exports.resetUsernamePassword = async (req, res) => {
  ...
  try {
    ...
    res.json({
      message: "Username and/or password reset successfully"
    });
